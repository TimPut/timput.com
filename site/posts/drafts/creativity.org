Deterministic information processing always reduces entropy. The actual manifestation of a computation of course increases total entropy, but the result however has less entropy.
