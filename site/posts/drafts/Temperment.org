...
Twelve-tone Equal Temperment (TET) was invented to allow musicians to
...
multiple different keys with only smaller temperment related tuning
...
optimal frequencies and not to the persribed TET tones.
